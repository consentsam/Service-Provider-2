...
enum class PasswordStrength private constructor(internal var resId: Int, color: Int) {
    ...
    WEAK(R.string.password_strength_weak, Color.rgb(127, 127, 127)),
    MEDIUM(R.string.password_strength_medium, Color.rgb(255, 255, 102)),
    STRONG(R.string.password_strength_strong,  Color.rgb(0, 76, 153)),
